...
export default function AuthenticateSubmissionButton({
  submissionId,
}: {
  submissionId: string;
}) {
  ...
  const [state, formAction] = useFormState(approvalPengesah, undefined);
        ...
        <Tooltip>
          <AlertDialogTrigger asChild>
            <TooltipTrigger asChild>
              <Button className="w-full flex items-center gap-2" variant={"success"}>
                <Icon
