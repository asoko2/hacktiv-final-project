import { sendReject } from "@/api/submissions-api";
...
export default function RejectSubmissionButton({
  ...
  const [state, formAction] = useFormState(sendReject, initialState);
      ...
      <AlertDialogContent>
        ...
        <form action={formAction}>
          ...
          <div className="flex flex-col gap-2 mb-4">
            <Label htmlFor="reason">Alasan Tolak</Label>
            <Textarea
              id="reason"
              name="reason"
          ...
          <div className="flex justify-end">
            <div className="w-1/2 flex gap-2">
              ...
              <SubmitButton variant="destructive">Tolak</SubmitButton>
            </div>
          </div>
        </form>
      </AlertDialogContent>
