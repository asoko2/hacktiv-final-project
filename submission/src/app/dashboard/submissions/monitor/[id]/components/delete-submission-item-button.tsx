"use client";
import { deleteSubmissionItem } from "@/api/submission-items-api";
...
export default function DeleteSubmissionItemButton({
  data,
}: {
  data: SubmissionItem;
}) {
    ...
    <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Data item {data.itemName} akan dihapus permanen.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
